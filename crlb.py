...
class CRLB_AdditiveGaussianZeroProcess(object):
...
def crlb_radar_ais():
    ...
    return (CRLB_AdditiveGaussianZeroProcess(transition_jacobi, measurement_jacobi, R), J0)
